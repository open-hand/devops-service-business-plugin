...
databaseChangeLog(logicalFilePath: 'script/db/fd_project_relationship.groovy') {
    ...
    changeSet(author: 'ztxemail@163.com', id: '2021-02-03-fd-project-relationship-add-column-sequence') {
        addColumn(tableName: 'FD_PROJECT_RELATIONSHIP') {
            column(name: 'sequence', type: 'INTEGER UNSIGNED', remarks: '排序', afterColumn: 'RESPONSIBILITY_USER_ID')
        }
    }
}