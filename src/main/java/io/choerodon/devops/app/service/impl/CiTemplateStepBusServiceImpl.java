...
public class CiTemplateStepBusServiceImpl implements CiTemplateStepBusService {
    ...
    @Override
    public Page<CiTemplateStepVO> pageTemplateStep(Long sourceId, PageRequest pageRequest, String name, String categoryName, Long categoryId, Boolean builtIn, String params) {
        Page<CiTemplateStepVO> templateStepDTOPageContent = PageHelper.doPageAndSort(pageRequest, () -> ciTemplateStepBusMapper.queryTemplateStepByParams(sourceId, name, categoryName, categoryId, builtIn, params));
