...
public class CiPipelineTemplateBusServiceImpl implements CiPipelineTemplateBusService {
    ...
    @Override
    public Page<CiTemplatePipelineVO> pagePipelineTemplate(Long sourceId, PageRequest pageRequest, String name, Long categoryId, Boolean builtIn, Boolean enable, String params) {
        Page<CiTemplatePipelineVO> pipelineTemplateVOS = PageHelper.doPageAndSort(pageRequest, () -> ciPipelineTemplateBusMapper.queryDevopsPipelineTemplateByParams(sourceId, name, null, categoryId, builtIn, enable, params));
